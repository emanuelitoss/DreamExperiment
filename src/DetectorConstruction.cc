...
{  
  ...
  // Envelope parameters
  //
  G4double env_sizeXZ = 25*cm, env_sizeY = 65*cm;
  ...
  */
  ...
  // BGO shape      
  G4double shape_bgoYZ =  2.2*cm, shape_bgoX = 18*cm;
  G4Box* BGOShape = new G4Box("BGO Box", 0.5*shape_bgoX, 0.5*shape_bgoYZ, 0.5*shape_bgoYZ);
  ...
  G4double shape_plasticX = 1.5*cm, shape_plasticY = 10*cm, shape_plasticZ = 5*cm;
  ...
  G4double distance_between_plastics = 0.3*cm;

  // Plastic scintillators positions
  G4ThreeVector trigger_1 = G4ThreeVector(0, -fixed_distance-0.5*shape_plasticY+0.5*distance_between_plastics, 0);
  G4ThreeVector trigger_2 = G4ThreeVector(0, -fixed_distance-1.5*shape_plasticY-0.5*distance_between_plastics, 0);
